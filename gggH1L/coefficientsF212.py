...
coeff = [ 
    ...
    [Coefficient(P1num,P1den,['eps'],parameters),
    
    # P2  - g2(s12,mtsq) coefficient
    Coefficient(P2num,P2den,['eps'],parameters),

    # P3  - g2(s13,mtsq) coefficient
    Coefficient(P3num,P3den,['eps'],parameters),

    # P4  - g3(s23,mtsq) coefficient
    Coefficient(P4num,P4den,['eps'],parameters),

    # P5  - g4(mhsq,mtsq) coefficient
    Coefficient(P5num,P5den,['eps'],parameters),

    # P6  - g5(s12,mtsq) coefficient
    Coefficient(P6num,P6den,['eps'],parameters),

    # P7  - g5(s13,mtsq) coefficient
    Coefficient(P7num,P7den,['eps'],parameters),

    # P8  - g6(s23,mtsq) coefficient
    Coefficient(P8num,P8den,['eps'],parameters),

    # P9  - g7(s12,mhsq,mtsq)  coefficient
    Coefficient(P9num,P9den,['eps'],parameters),

    # P10  - g7(s13,mhsq,mtsq) coefficient
    Coefficient(P10num,P10den,['eps'],parameters),

    # P11  - g8(s23,mhsq,mtsq) coefficient
    Coefficient(P11num,P11den,['eps'],parameters),

    # P12  - g9(s12,s23,mhsq,mtsq) coefficient
    Coefficient(P12num,P12den,['eps'],parameters),

    # P13  - g9(s12,s13,mhsq,mtsq) coefficient
    Coefficient(P13num,P13den,['eps'],parameters),

    # P14  - g9(s23,s13,mhsq,mtsq) coefficient
    Coefficient(P14num,P14den,['eps'],parameters)]
