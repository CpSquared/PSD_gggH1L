...
def g2_0(s12,mh2,mt2):
    analytic0 = -(6*mt2 + s12)/(12*mt2**2)
    return analytic0

def g2_eps(s12,mh2,mt2):
    analytic1 =  -(s12 + (6*mt2 + s12)*math.log(1/mt2))/(12*mt2**2)
    analytic2 = (g2_0(s12,mh2,mt2)*(-1*EulerGamma) + analytic1)
    return analytic2
...
print('eps^0 : ',g2_0(s1,mhsq,mtsq))
print('eps : ',g2_eps(s1,mhsq,mtsq))
